...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-m(r)rysybpqb+-7_k+-7z@i_i3*q94fc#5i&no9qkc-!(*5^%+')
...
REST_FRAMEWORK = {
    'DEFAULT_PERMISSION_CLASSES': [
        'rest_framework.permissions.AllowAny',  # Allow anonymous for demo
    ],
